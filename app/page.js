      ...
      <main className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center justify-center min-h-[calc(100vh-4rem)]">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12">
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold tracking-tight mb-6">
            <span className="block text-primary/30 mb-2 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
              Welcome Buddy
            </span>
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.8s" }}>
            Only the best names and domains.
          </p>
        </div>

        {/* Search Bar Container */}
        <div className="w-full max-w-2xl mx-auto mb-20 animate-fade-in-up" style={{ animationDelay: "1s" }}>
